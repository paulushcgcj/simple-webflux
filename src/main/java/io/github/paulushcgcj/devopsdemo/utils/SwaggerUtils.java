...
public class SwaggerUtils {
  ...
  public static <T> Consumer<Builder> buildApi(
      String operation, String description, String tag, Class<T> tClass) {
    return ops ->
        ops.tag(tag)
            .beanClass(tClass)
  ...
  public static org.springdoc.core.fn.builders.apiresponse.Builder notFoundOps(String example) {
    return responseOps(
        "404",
        "Not Found",
  ...
  public static org.springdoc.core.fn.builders.apiresponse.Builder okOps(Class<Company> schema) {
    return responseOps("200", "OK", contentBuilder().schema(classSchema(schema)));
  }

  public static org.springdoc.core.fn.builders.apiresponse.Builder okListOps(
      Class<Company> schema) {
    return responseOps(
        "200", "OK", contentBuilder().array(arraySchemaBuilder().schema(classSchema(schema))));
  }

  public static org.springdoc.core.fn.builders.apiresponse.Builder badRequestOps(String example) {
    return responseOps(
        "400",
  ...
  public static org.springdoc.core.fn.builders.apiresponse.Builder conflictOps(String example) {
    return responseOps(
        "409",
        "Conflict",
        contentBuilder().schema(SwaggerUtils.classSchema(String.class, example)));
  ...
  public static org.springdoc.core.fn.builders.apiresponse.Builder createdOps(
      String exampleSchema) {
    return responseOps("201", "Created", contentBuilder().schema(schemaBuilder()))
        .header(
            headerBuilder()
                .name("Location")
  ...
  public static org.springdoc.core.fn.builders.apiresponse.Builder acceptedOps() {
    return responseOps("202", "Accepted", contentBuilder().schema(schemaBuilder()));
  }

  public static org.springdoc.core.fn.builders.apiresponse.Builder noContentOps() {
    return responseOps("204", "No Content", contentBuilder().schema(schemaBuilder()));
  }
  ...
  public static <T> org.springdoc.core.fn.builders.requestbody.Builder requestBodyOps(
      Class<T> tClass) {
